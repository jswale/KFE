...
var MH_Play_Play_vue = $.inherit(Page, {
    ...
    addMonsterLevel : function() {
        ...
        // Ajout de la colonne titre
        $("#mh_vue_hidden_monstres table:first thead tr.mh_tdtitre:first th:nth-child(" + refColId + ")").after('<th width="50px" data-type="numeric" class="footable-visible footable-sortable"><b>Niveau</b><span class="footable-sort-indicator"></span></th>');
